<?php
    ...
    $page_title =  __( 'Settings of Newsletter Professional plugin', 'email-newsletter' );

    if ( ! $settings ) {
        $page_title =  __( 'Install Settings of Newsletter Professional plugin', 'email-newsletter' );
